<div class="panel-body">
    ...
    <div class="row">
        <div class="form-group">
            ...
            {!! Form::select('categoria',$categorias, null ,['class' => 'form-control', 'placeholder' => '00,00 %',]) !!}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            {!! Form::text('juros', null ,['class' => 'form-control', 'onblur' => 'calculaValorParcela()']) !!}
        </div>
        ...
        <div class="form-group">
            ...
            {!! Form::text('total', null ,['class' => 'form-control', 'placeholder' => 'R$ 00,00']) !!}
        </div>
