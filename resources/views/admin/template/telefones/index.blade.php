        ...
        <div class="col-md-12">
            ...
            <div class="portlet box red">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>Telefone
                    </div>
                    <a href="{{ route('admin.telefone.create')}}" class="btn btn-success fileinput-button"><i class="glyphicon glyphicon-plus"></i><span> Novo telefone</span></a>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table-scrollable">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            @foreach($telefones as $produto)
                                <tr>

                                    <td>{{$produto->fone}}</td>
                                    <td>
                                        <a href="{{ route('admin.telefone.edit', ['id' => $produto->id]) }}" class="btn btn-info btn-sm">Editar</a>
                                        <a href="{{ route('admin.telefone.destroy', ['id' => $produto->id]) }}" class="btn btn-danger btn-sm">Deletar</a>
                                    </td>
